...
public:
	...
	void insert(int index, IP element)override
	{
		if (index < 0)
		{
			if (index + list_of_IPv4.size() >= 0)
			{
				list_of_IPv4.push_back(element);
				int i = list_of_IPv4.size() - 1;
				while (i != index + list_of_IPv4.size())
				{
	...
	void remove(int index)override
	{
		...
		{
			if (index + list_of_IPv4.size() >= 0)
				list_of_IPv4.erase(list_of_IPv4.begin() + list_of_IPv4.size() + index);
			else
				error_wrong_index();
		}
		else
	...
	IP get(int index)
	{
		...
		{
			if (index + list_of_IPv4.size() >= 0)
				return list_of_IPv4[index + list_of_IPv4.size()];
			else
				error_wrong_index();
		}
		else
	...
	void set(int index, IP element)override
	{
		...
		{
			if (index + list_of_IPv4.size() >= 0)
				list_of_IPv4[index + list_of_IPv4.size()] = element;
			else
				error_wrong_index();
		}
		else
