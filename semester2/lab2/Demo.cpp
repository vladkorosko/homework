...
void demonstrative_mode()
{
	...
	cout << blue + "Now i get element with index 0 from array list." << endl;
	cout << green << Array_list.get(0).ipv4 << endl;
	Sys_pause();

	cout << blue + "Now i get element with index 0 from vector list." << endl;
	cout << green << Vector_list.get(0).ipv4 << endl;
	Sys_pause();
	
	cout << blue + "Now i get element with index 0 from linked list." << endl;
	cout << green << linked_list.get(0).ipv4 << endl;
	Sys_pause();

	Our_IP.ipv4 = "101.102.123.129";
	cout << blue + "Now i set element with index 0 from array list as 101.102.123.129." << endl;
	Array_list.set(0, Our_IP);
	Vector_list.set(0, Our_IP);
	linked_list.set(0, Our_IP);
	Sys_pause();
